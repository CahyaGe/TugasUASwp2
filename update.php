	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-success" style="margin-top:125px">
					<div class="panel-body">
						...
						<div class="form-group">
								...
								<input name="nama" value="<?php echo $s['n_mahasiswa'];?>" type="text" class="form-control" id="" placeholder="Masukan Nilai Mahasiswa" required="required">
							</div>
						<label>Tugas</label>
						<input type="hidden" name="nim" value="<?php echo $id;?>" type="text" class="form-control" id="" required="required">
							...
							<button name="edit" type="submit" class="btn btn-info">SIMPAN</button> &nbsp; <button type="cancel" class="btn btn-danger">BATAL</button>
						</form>
